...
ALTER TABLE public.subject OWNER TO diva;

--
-- Name: subject_name; Type: TABLE; Schema: public; Owner: diva
--

CREATE TABLE public.subject_name (
...
ALTER TABLE public.subject_name OWNER TO diva;

--
-- Name: subject_parent; Type: TABLE; Schema: public; Owner: diva
--

CREATE TABLE public.subject_parent (
    parent_subject_id integer NOT NULL,
    subject_id integer NOT NULL
);


ALTER TABLE public.subject_parent OWNER TO diva;

--
-- Name: subject_predecessor; Type: TABLE; Schema: public; Owner: diva
--

CREATE TABLE public.subject_predecessor (
    predecessor_subject_id integer NOT NULL,
    subject_id integer NOT NULL
);


ALTER TABLE public.subject_predecessor OWNER TO diva;
...
ALTER TABLE public.subject_type OWNER TO diva;

--
-- Name: subject_type_name; Type: TABLE; Schema: public; Owner: diva
--

CREATE TABLE public.subject_type_name (
...
ALTER TABLE public.subject_type_name OWNER TO diva;

--
-- Data for Name: subject; Type: TABLE DATA; Schema: public; Owner: diva
--

COPY public.subject (subject_id, last_updated, domain, closed_date, old_diva_db, old_diva_id, subject_code, subject_type_id, not_eligible) FROM stdin;
...
COPY public.subject_name (subject_name_id, last_updated, locale, subject_name, subject_id, lastupdated) FROM stdin;
...
COPY public.subject_parent (parent_subject_id, subject_id) FROM stdin;
251	250
58	59
61	59
62	58
...
COPY public.subject_predecessor (predecessor_subject_id, subject_id) FROM stdin;
\.
...
COPY public.subject_type (subject_type_id, last_updated, subject_type_code) FROM stdin;
...
COPY public.subject_type_name (subject_type_name_id, last_updated, locale, subject_type_name, subject_type_id) FROM stdin;
...
--
-- Name: subject_name subject_name_pkey; Type: CONSTRAINT; Schema: public; Owner: diva
--

ALTER TABLE ONLY public.subject_name
    ADD CONSTRAINT subject_name_pkey PRIMARY KEY (subject_name_id);


--
-- Name: subject_name subject_name_subject_id_key; Type: CONSTRAINT; Schema: public; Owner: diva
--
...
--
-- Name: subject_parent subject_parent_pkey; Type: CONSTRAINT; Schema: public; Owner: diva
--

ALTER TABLE ONLY public.subject_parent
    ADD CONSTRAINT subject_parent_pkey PRIMARY KEY (parent_subject_id, subject_id);


--
-- Name: subject subject_pkey; Type: CONSTRAINT; Schema: public; Owner: diva
--
...
--
-- Name: subject_predecessor subject_predecessor_pkey; Type: CONSTRAINT; Schema: public; Owner: diva
--

ALTER TABLE ONLY public.subject_predecessor
    ADD CONSTRAINT subject_predecessor_pkey PRIMARY KEY (predecessor_subject_id, subject_id);


--
-- Name: subject subject_subject_type_id_key; Type: CONSTRAINT; Schema: public; Owner: diva
--
...
--
-- Name: subject_type_name subject_type_name_pkey; Type: CONSTRAINT; Schema: public; Owner: diva
--

ALTER TABLE ONLY public.subject_type_name
    ADD CONSTRAINT subject_type_name_pkey PRIMARY KEY (subject_type_name_id);


--
-- Name: subject_type_name subject_type_name_subject_type_id_key; Type: CONSTRAINT; Schema: public; Owner: diva
--
...
--
-- Name: subject_type subject_type_pkey; Type: CONSTRAINT; Schema: public; Owner: diva
--
...
--
-- Name: subject_type subject_type_subject_type_code_key; Type: CONSTRAINT; Schema: public; Owner: diva
--
...
--
-- Name: subject_parent fk40cac71df3175081; Type: FK CONSTRAINT; Schema: public; Owner: diva
--

ALTER TABLE ONLY public.subject_parent
    ADD CONSTRAINT fk40cac71df3175081 FOREIGN KEY (subject_id) REFERENCES public.subject(subject_id);


--
-- Name: subject_parent fk40cac71df8d6f36; Type: FK CONSTRAINT; Schema: public; Owner: diva
--

ALTER TABLE ONLY public.subject_parent
    ADD CONSTRAINT fk40cac71df8d6f36 FOREIGN KEY (parent_subject_id) REFERENCES public.subject(subject_id);


--
-- Name: subject fk90aa552c68642914; Type: FK CONSTRAINT; Schema: public; Owner: diva
--

ALTER TABLE ONLY public.subject
    ADD CONSTRAINT fk90aa552c68642914 FOREIGN KEY (subject_type_id) REFERENCES public.subject_type(subject_type_id);


--
-- Name: subject_type_name fk9105e11d68642914; Type: FK CONSTRAINT; Schema: public; Owner: diva
--

ALTER TABLE ONLY public.subject_type_name
    ADD CONSTRAINT fk9105e11d68642914 FOREIGN KEY (subject_type_id) REFERENCES public.subject_type(subject_type_id);


--
-- Name: subject_name fka60639bef3175081; Type: FK CONSTRAINT; Schema: public; Owner: diva
--

ALTER TABLE ONLY public.subject_name
    ADD CONSTRAINT fka60639bef3175081 FOREIGN KEY (subject_id) REFERENCES public.subject(subject_id);


--
-- Name: subject_predecessor fkc986a876cde5bf77; Type: FK CONSTRAINT; Schema: public; Owner: diva
--

ALTER TABLE ONLY public.subject_predecessor
    ADD CONSTRAINT fkc986a876cde5bf77 FOREIGN KEY (predecessor_subject_id) REFERENCES public.subject(subject_id);


--
-- Name: subject_predecessor fkc986a876f3175081; Type: FK CONSTRAINT; Schema: public; Owner: diva
--

ALTER TABLE ONLY public.subject_predecessor
    ADD CONSTRAINT fkc986a876f3175081 FOREIGN KEY (subject_id) REFERENCES public.subject(subject_id);
