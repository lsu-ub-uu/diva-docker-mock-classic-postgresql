...
create view nationalsubject as select s.subject_id as id, s.subject_code, sn.name as default_name, sn.alternative_name from subject s left join  subject_name_complete sn on s.subject_id = sn.id where s.subject_type_id = 57;
